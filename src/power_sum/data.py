"""
Data class for Kaggle train/test data
"""
import numpy as np
import pandas as pd
import h5py
...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i: int):
        ...
        ret = {'x': x,       # Fourier coefficient (complex64)
               'mask': mask,
               'freq': d['frequency'],
               'y': np.float(d['y']),
...
class _Data:
    ...
    def loader(self, batch_size=32, num_workers=1, *, shuffle=False, drop_last=False):
